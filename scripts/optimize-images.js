...
function generateImportsFile(processedImages, outputDir) {
  ...
  processedImages.forEach(img => {
    const key = img.baseName.replace(/-medium$/i, '').replace(/\s+/g, '_')
    ...
    entries.push(`  "${key}": { medium: ${importName}, thumb: ${importName}, small: ${importName}, large: ${importName}, full: ${importName} }`)
  })
