...
.scene-container {
  ...
  overflow: hidden;
  box-shadow: 
    0 10px 40px rgba(44, 36, 22, 0.2),
    0 4px 12px rgba(107, 28, 35, 0.1);
...
.map-silhouette {
  position: absolute;
  inset: 0;
  background: radial-gradient(circle at 30% 40%, rgba(196, 93, 63, 0.15), transparent 45%),
    radial-gradient(circle at 70% 60%, rgba(107, 28, 35, 0.12), transparent 50%);
  opacity: 0.6;
}
...
.route-line {
  ...
  background: linear-gradient(90deg, 
    rgba(107, 28, 35, 0.4) 0%, 
    rgba(196, 93, 63, 0.5) 50%, 
    rgba(107, 28, 35, 0.4) 100%);
  border-radius: 2px;
}
...
.route-dot.active {
  ...
  box-shadow: 0 0 0 6px rgba(107, 28, 35, 0.15);
}
...
.plane {
  ...
  font-size: 1.1rem;
  box-shadow: 
    0 6px 20px rgba(44, 36, 22, 0.15),
    0 3px 6px rgba(107, 28, 35, 0.1);
