<template>
  <section class="timeline">
    <h2 class="timeline-title">Il Nostro Viaggio</h2>
    <p class="timeline-subtitle">I momenti che hanno segnato la nostra storia</p>
...
.timeline-container::before {
  ...
  background: linear-gradient(to bottom, 
    transparent 0%,
    var(--wine-burgundy) 10%,
    var(--wine-burgundy) 90%,
    transparent 100%
  );
...
.marker-dot {
  ...
  border-radius: 50%;
  box-shadow: 0 0 0 4px var(--wine-burgundy);
